                        ...
                        <div class="row mt-3">
                                ...
                                <div class="col-lg-4 col-md-6 mt-4">
                                    ...
                                    <select name="unit" class="form-control select2" style="width: 100%" required>
                                        ...
                                        @foreach ($units as $unit)
                                            <option value="{{ $unit->id }}" @selected(old('unit', $product->unit_id) == $unit->id)>
                                                {{ $unit->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6 col-lg-4 mt-4">
                                ...
                                <select name="vat_tax_id" class="form-control select2" style="width: 100%" required>
                                    <option value="" disabled>{{ __('Select GST / VAT Rate') }}</option>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-4 col-md-6 mt-3 {{ $product->is_digital ? 'd-block' : 'd-none' }}">
                                ...
                                <x-input id="licenseQtyCount" type="text" name="quantity"
                                    label="Digital License Quantity" placeholder="Digital License Quantity" onlyNumber="true"
