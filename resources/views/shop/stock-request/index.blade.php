...
<div class="card border-0 shadow-sm rounded-12 mb-4 bg-gradient bg-primary text-white">
    <div class="card-body p-3">
        ...
        <div class="d-flex justify-content-between align-items-center mb-1">
            <h1 class="h4 mb-0 text-white fw-bold"><i class="fas fa-clipboard-list me-2 text-warning"></i>{{ __('Warehouse Stock Requests') }}</h1>
            <div class="d-flex gap-2">
                <a href="{{ route('shop.shop-inventory.index') }}" class="btn btn-sm btn-light text-primary fw-bold">
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 text-white-50 small">
            <span>{{ __('Manage and request physical inventory dispatches from central warehouses into sellable shop stock.') }}</span>
            @if($warehouse)
