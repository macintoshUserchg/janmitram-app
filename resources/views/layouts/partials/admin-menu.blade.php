...
@endhasPermission
@hasPermission(['admin.country.index', 'admin.area.index'])
    <!--- Address --->
    <li>
        <a class="menu {{ request()->routeIs('admin.country.*', 'admin.area.*') ? 'active' : '' }}"
        ...
        <div class="collapse dropdownMenuCollapse {{ $request->routeIs('admin.country.*', 'admin.area.*') ? 'show' : '' }}"
            id="addressMenu">
            <div class="listBar">
                @hasPermission('admin.country.index')
                    <a href="{{ route('admin.country.index') }}"
                        class="subMenu hasCount {{ request()->routeIs('admin.country.*') ? 'active' : '' }}">
                        {{ __('Country') }}
                    </a>
                @endhasPermission
