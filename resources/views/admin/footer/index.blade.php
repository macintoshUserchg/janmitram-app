                                                    ...
                                                    <div class="accordion-body border">
                                                        <form action="{{ route('admin.footer.update', $footer->id) }}"
                                                            ...
                                                            <x-input name="title" label="Title" type="text" class="form-control-sm"
                                                                ...
                                                                required="true" />
                                                            <x-input name="ar_title" label="Title (Arabic)" type="text" class="form-control-sm"
                                                            ...
                                                            <form method="POST"
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    @else
                                                                        ...
                                                                        <div class="col-12 mb-3">
                                                                            <label class="form-label mb-1">
                                                                                {{ __('Navigation Label (Arabic)') }}
                                                                            </label>
                                                                            <input type="text"
                                                                                class="form-control form-control-sm"
                                                                                placeholder="{{ __('Navigation Label (Arabic)') }}"
                                                                                name="ar_title"
                                                                                value="{{ $item->ar_title }}"
                                                                                required="">
                                                                        </div>
