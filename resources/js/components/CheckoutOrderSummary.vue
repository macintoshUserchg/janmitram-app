    ...
    <div>
        <div class="p-6 bg-white rounded-2xl border border-slate-200">
            ...
            >
                ...
                <div v-if="basketStore.all_vat_taxes?.length > 0" class="mt-2 pt-2 border-t border-slate-200/60 space-y-1">
                    <div
...
const openPaymentPopupWindow = (url) => {
    ...
    function trackURLChanges() {
        try {
            ...
            // Cross-origin blocked during payment gateway redirect
        }
    }
