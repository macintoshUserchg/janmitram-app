...
<?php $__env->startSection('content'); ?>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div class="dashboard-box item-3">
                        <h2 class="count"><?php echo e($totalCategories); ?></h2>
                        <h3 class="title"><?php echo e(__('Total Categories')); ?></h3>
                        <div class="icon svg-bg">
                            <img src="<?php echo e(asset('assets/icons-admin/category.svg')); ?>" alt="icon" loading="lazy" />
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div class="dashboard-box item-4">
                        <h2 class="count"><?php echo e($totalBrand); ?></h2>
                        <h3 class="title"><?php echo e(__('Total Brands')); ?></h3>
                        <div class="icon svg-bg">
                            <img src="<?php echo e(asset('assets/icons-admin/brand.svg')); ?>" alt="icon" loading="lazy" />
                        </div>
                    </div>
                </div>
    ...
    <div class="card mt-4">
        <div class="card-body">
            <div class="cardTitleBox">
                <h5 class="card-title chartTitle">
                    <i class="bi bi-wallet2"></i> <?php echo e(__('Shop Wallet')); ?>
            ...
            <div class="row">
                    ...
                    <div class="wallet h-100">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-2 flex-wrap w-100">
                            <div>
                                ...
                                <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'shop.withdraw.store')): ?>
                                    <div class="title"><?php echo e(__('Available Balance')); ?></div>
                ...
                <div class="col-lg-7">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="wallet-others">
                                ...
                                <div class="d-flex align-items-center gap-2 justify-content-between">
                                    ...
                                    <div class="icon">
                                        <img src="<?php echo e(asset('assets/icons-admin/credit-card-convert.svg')); ?>"
                                            alt="icon" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="wallet-others">
                                ...
                                <div class="d-flex align-items-center gap-2 justify-content-between">
                                    ...
                                    <div class="icon">
                                        <img src="<?php echo e(asset('assets/icons-admin/withdraw-reject.svg')); ?>"
                                            alt="icon" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="wallet-others">
                                <div class="amount"><?php echo e(showCurrency($totalWithdraw)); ?></div>
                                <div class="d-flex align-items-center gap-2 justify-content-between">
                        ...
                        <div class="col-md-6">
                            <div class="wallet-others">
                                <div class="amount"><?php echo e(showCurrency($totalDeliveryCollected)); ?></div>
                                <div class="d-flex align-items-center gap-2 justify-content-between">
                                    <div class="title"><?php echo e(__('Delivery Charge Collected')); ?></div>
                                    <div class="icon">
                                        <img src="<?php echo e(asset('assets/icons/deliveryCharge.png')); ?>" alt="icon" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="wallet-others">
                                <div class="amount"><?php echo e(showCurrency($totalPosSales)); ?></div>
                                <div class="d-flex align-items-center gap-2 justify-content-between">
                                    <div class="title"><?php echo e(__('Total Pos Sales')); ?></div>
                                    <div class="icon svg-bg">
                                        <img src="<?php echo e(asset('assets/icons-admin/pos-sale.svg')); ?>" alt="icon" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5"><?php echo e(__('Withdraw Request')); ?></h1>
                        ...
                        <div class="modal-body">
                            <div>
                                <label class="form-label">
                                    <?php echo e(__('Withdraw Amount')); ?> <span class="text-danger">*</span>
                                </label>
                            ...
                            <div class="mt-3">
                                <label class="form-label">
                                    <?php echo e(__('Contact Number')); ?> <span class="text-danger">*</span>
                                </label>
                            ...
                            <div class="mt-3">
                                <label class="form-label"><?php echo e(__('Any message')); ?></label>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" id="submitBtn" class="btn btn-primary"><?php echo e(__('Submit')); ?></button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card mt-3">
        <div class="card-body">
            <div class="cardTitleBox">
                <h5 class="card-title chartTitle">
                    <?php echo e(__('Order Summary')); ?> <span style="color: #687387">(<?php echo e(__('latest 8th orders')); ?>)</span>
                </h5>
            </div>
                        ...
                        <?php $__currentLoopData = $latestOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="tableAction">
                                    <a href="<?php echo e(route('shop.order.show', $order->id)); ?>" data-bs-toggle="tooltip"
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column gap-1">
                        <?php $__currentLoopData = $topSellingProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('shop.product.show', $product->id)); ?>" class="customer-section">
                                <div class="customer-details">
                                    <div class="customer-image">
                                        <img src="<?php echo e($product->thumbnail); ?>" alt="">
                                    </div>
                                    <div class="customer-about">
                                        <p class="text-dark name"><?php echo e(Str::limit($product->name, 30, '...')); ?></p>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        $('#withdrawForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('shop.withdraw.store')); ?>",
                type: "POST",
                data: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u939461333/domains/janmitram.com/public_html/app/resources/views/shop/dashboard.blade.php ENDPATH**/ ?>