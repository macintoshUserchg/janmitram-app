...
<head>
    ...
    <!-- App title -->
    <title><?php echo e($generaleSetting?->title ?? config('app.name', 'Laravel')); ?> Admin Login</title>
    <meta name="viewport"
...
<body style="background: url(<?php echo e(asset('assets/images/admin-bg.svg')); ?>)">

    <section class="login-section">

        <div class="thumbnail position-relative text-primary">
            <img src="<?php echo e(asset('assets/images/login.svg')); ?>" alt="thumbnail" width="100%" loading="lazy" />
            <div class="logo_right">
                <img src="<?php echo e($generaleSetting?->favicon ?? asset('assets/favicon.png')); ?>" alt="logo"
                    loading="lazy" />
                <span class="site_name"><?php echo e($generaleSetting?->name ?? config('app.name')); ?></span>
            </div>
        </div>
            ...
            <div class="card-body">
                <?php if(app()->isLocal()): ?>
                    <div class="d-flex justify-content-between align-items-center gap-2">
                        ...
                        <span class="version fw-bold">v<?php echo e(config('app.version')); ?></span>
                    </div>
                <?php endif; ?>

                <div class="text-center mt-4">
                    <img src="<?php echo e($generaleSetting?->logo ?? asset('assets/logo.png')); ?>" alt="" height="80"
                        style="max-width: 100%">
                </div>
                ...
                <div class="page-content text-center mb-4">
                    <p class="pagePera my-3">
                        ...
                        <span class="fw-bold text-primary text-capitalize">
                            <?php echo e($generaleSetting?->name ?? config('app.name', 'Laravel')); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php if($GoogleReCaptcha?->is_active): ?>
                        <div>
...
unset($__errorArgs, $__bag); ?>
    ...
    <script>
        ...
        const gotoShopLogin = () => {
            ...
            window.open("<?php echo e(route('shop.login')); ?>", '_blank');
        }
...
<?php /**PATH /home/u939461333/domains/janmitram.com/public_html/app/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>