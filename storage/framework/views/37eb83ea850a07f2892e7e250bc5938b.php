<?php $__env->startSection('content'); ?>
    <div class="d-flex flex-column justify-content-center align-items-center vh-100 bg-light">
        ...
        <a href="<?php echo e(request()->is('admin', 'admin/*') ? route('admin.dashboard.index') : route('shop.dashboard.index')); ?>" class="btn btn-primary mt-4 px-4 py-2">
            Back to Dashboard
        </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u939461333/domains/janmitram.com/public_html/app/resources/views/errors/403.blade.php ENDPATH**/ ?>